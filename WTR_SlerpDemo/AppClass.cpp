...
void AppClass::Update(void)
{
	...
	quaternion q2 = glm::quat(vector3(0.0f,glm::radians(90.0f), 0.0f)); // <- this engine specific
	//quaternion q3 = glm::angleAxis(90.0f, vector3(1.0f, 0.0f, 0.0f)); //note* not axisAngle
	quaternion q1 = glm::angleAxis(90.0f, vector3(1.0f, 0.0f, 0.0f)); //note* not axisAngle
