...
void AppClass::InitVariables(void)
{
	...
	m_pCone->GenerateCone(1, 1, 6, REBLUE);
	m_pCylinder->GenerateCylinder(1, 1, 6, REGREEN);
	m_pTube->GenerateTube(1, 0.5, 1, 6, REORANGE);
	m_pTorus->GenerateTorus(1, 0.5, 6, 6, REPURPLE);
